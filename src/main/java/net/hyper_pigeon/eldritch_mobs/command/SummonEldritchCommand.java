...
public class SummonEldritchCommand {
    ...
    private static final SimpleCommandExceptionType FAILED_UUID_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.summon_eldritch.failed.uuid"));

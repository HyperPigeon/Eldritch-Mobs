...
public class SummonUltraCommand{
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder) CommandManager.literal("summon_ultra").requires((source) -> {
        ...
        if (!World.isValid(blockPos)) {
            ...
            if (entity2 == null) {
                ...
                if (initialize && entity2 instanceof MobEntity) {
                    ...
                    EldritchMobsMod.ELDRITCH_MODIFIERS.get(entity2).setRank(MobRank.ULTRA);
                ...
                if (!serverWorld.spawnNewEntityAndPassengers(entity2)) {
                    ...
                    source.sendFeedback(Text.translatable("commands.summon_ultra.success", new Object[]{entity2.getDisplayName()}), true);
                    return 1;
                }
            }
        }

...
public class SummonUltraCommand{
    ...
    private static final SimpleCommandExceptionType FAILED_UUID_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.summon_ultra.failed.uuid"));
